 ...
 */
public class TipoCuerpoAguaDAO implements BD_Operaciones_int{
    // Atributos de la clase
    private ArrayList<String> lista_cuerpos_de_agua;
    private Conexion conexion;
    
    // Constructor

    public TipoCuerpoAguaDAO() {
        this.lista_cuerpos_de_agua = new ArrayList();
        this.conexion = new Conexion();
    }
    
    // Get y set

    public ArrayList<String> getLista_cuerpos_de_agua() {
        return lista_cuerpos_de_agua;
    }

    public void setLista_cuerpos_de_agua(ArrayList<String> lista_cuerpos_de_agua) {
        this.lista_cuerpos_de_agua = lista_cuerpos_de_agua;
    }
    ...
    public boolean consultar() {
         System.out.println("Consultar los tipos de cuerpos de agua");
        ...
        if (this.conexion.getBandera()) {  // Necesito primero que todo evaluar que la conexión a la base de datos no sea nula, en caso de ser true, hay conexión
            ...
            try {  // Intentar una operación con la base de datos, en este caso una inserción de un cuerpo de agua
                ...
                String sentencia = "select descripcion from Tipos_de_agua";
                ...
                while (resultado.next()) {  // Mientras halla registros en la consulta obtenida
                    ...
                    this.lista_cuerpos_de_agua.add(tipo_agua);
                }
                
                System.out.println("La consulta de los tipos de cuerpo de agua fue realizada");
                estado = true;
    ...
    private void reiniciarListaDatosSalida() {
        ...
        if (!this.lista_cuerpos_de_agua.isEmpty()) {  // Si y solo si hay elementos...
            this.lista_cuerpos_de_agua= new ArrayList();  // Reinicio el arreglo con los datos de salida para prevenir utilizar datos anteriores
        }
    }
